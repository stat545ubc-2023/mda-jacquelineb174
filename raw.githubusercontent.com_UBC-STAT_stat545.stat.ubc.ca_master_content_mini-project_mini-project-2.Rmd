...
``` 
Alpha transparency was adjusted for this graph as the majority of buildings were built between 1910 and 1980. I wanted a graph that would show this density and not block the number of the buildings built each year. 
...
<!-------------------------- Start your work below ---------------------------->
```{r}
broom::augment(model3.1, newdata = tibble(no_of_storeys = 15:17)) #produce prediction of number of elevators for buildings with storeys ranging from 15-17. This information is contained in column ".fitted" 
```
