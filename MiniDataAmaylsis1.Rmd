...
storeys <- ggplot(apt_buildings, aes(x=no_of_storeys)) + geom_histogram(binwidth = 1) ##create histogram for number of storeys in apartment buildings, adjusted bin width to see each storey number
print(storeys)
...
StoreysXYearBuilt <- ggplot(apt_buildings, aes(x = year_built, y = no_of_storeys)) + geom_point() ##plot relationship between year apartment was built and number of storeys in apartment. 
...
apt_build2.0 <- as_tibble(select(apt_buildings, id, air_conditioning, balconies, laundry_room, no_of_elevators, pets_allowed, year_built, no_of_storeys, no_of_units)) ##create tibble with desired variables, including all observations. 
print(apt_build2.0)
...
apt_1950 <- filter(apt_buildings, year_built >1950) ##filter apartment buildings to only show those built after 1950
print(apt_1950)
<!----------------------------------------------------------------------------->
